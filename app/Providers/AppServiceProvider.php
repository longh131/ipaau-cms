            ...
            $editor
                ...
                ->tools([
                    ...
                    RichEditorTool::make('attachFiles')
                        ->label('插入图片')
                        ->action(arguments: '{ alt: $getEditor().getAttributes(\'image\')?.alt, float: $getEditor().getAttributes(\'image\')?.float ?? null, class: $getEditor().getAttributes(\'image\')?.class ?? null, width: $getEditor().getAttributes(\'image\')?.width ?? null, id: $getEditor().getAttributes(\'image\')?.id, src: $getEditor().getAttributes(\'image\')?.src }')
                        ->activeKey('image')
                        ->icon(Heroicon::Photo)
