...
class CaseResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Resources\CaseResource\Pages\ListCases::route('/'),
            'create' => \App\Filament\Resources\CaseResource\Pages\CreateCase::route('/create'),
            'edit' => \App\Filament\Resources\CaseResource\Pages\EditCase::route('/{record}/edit'),
        ];
    }
}