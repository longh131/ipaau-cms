@extends('layouts.app', [
    'bodyClass' => 'cms-about-page cms-content-page cms-member-interview-page',
...
@section('content')
    ...
    <section
        data-type="memberInterviewListing"
        class="member-interview-listing pb-16"
        style="
            --ipa-color-light: oklch(0.464 0 0);
            --ipa-color-dark: oklch(1 0 0);
            --light-or-dark: light;
    ...
    >
        ...
        @else
            @foreach ($articles as $article)
                @include('frontend.partials.articles.member-interview-card', ['article' => $article])
            @endforeach

            @if($articles->hasPages())
                <nav class="inner container px-4 md:px-10 mx-auto cms-category-pagination mt-4" aria-label="会员专访分页">
