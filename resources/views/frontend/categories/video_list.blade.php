@extends('layouts.app', [
    'bodyClass' => 'cms-about-page cms-content-page cms-news-list-page cms-video-list-page',
...
@section('content')
    ...
    <section
        data-type="videoSection"
        class="cms-page-content-section cms-news-list-section cms-video-list-section pb-16"
        style="
            --bg-color: transparent;
            --ipa-color-light: oklch(0.464 0 0);
            --ipa-color-dark: oklch(1 0 0);
        ...
        <div class="inner container px-4 md:px-10 mx-auto">
            ...
            @else
                ...
                @if($articles->hasPages())
                    <nav class="cms-category-pagination mt-12" aria-label="视频分页">
