...
@if(filled($title ?? null))
    <h2 class="mb-0 font-medium font-din text-2xl leading-[1.4] tracking-[.04em] inline-flex gap-3 items-center text-link group-hover/noImageCard:underline group-hover/noImageCard:text-link-hover text-left">
        {{ $title }}
        @if($showArrow ?? false)
