@php
    /** @var array{tabs: array<int, array{tab_label: string, tagline: string, title: string, description: string, button_label: string, url: ?string, image: ?string}>} $tabbedContent */
    $tabbedContent = $tabbedContent ?? ['tabs' => []];
...
@if(! empty($tabs))
        ...
        >
          ...
          >
            <div class="container">
              <div
                class="grid grid-cols-1 gap-8 lg:gap-16 items-center lg:grid-cols-2"
              >
                <div class="lg:hidden">
                  <div
                    class="flex flex-wrap gap-4 mb-8 xl:mb-auto mt-8 shrink grow-0"
                  >
