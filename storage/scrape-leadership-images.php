...
$listUrl = $baseUrl . '/about-ipa/about-the-ipa/leadership-team/';
...
echo "Fetching leadership list...\n";
$listHtml = fetchBytes($listUrl);
$listData = extractPageData($listHtml);
$members = extractTeamMembers($listData);

if ($members === []) {
    throw new RuntimeException('No team members found on leadership list page.');
}
...
foreach ($members as $index => $member) {
    ...
    $filename = sprintf('%02d.jpg', $number);
